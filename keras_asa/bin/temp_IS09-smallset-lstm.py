...
for fpath in types:
    ...
    if fpath == "../../SJP_JC_Audio/perception_results/fluency_avgs.csv":
        wfile = open('../../SJP_JC_Audio/gridsearch/phonetic_IS09-smallset_lstm_fluency.csv', 'w')
    elif fpath == "../../SJP_JC_Audio/perception_results/comp_avgs.csv":
        wfile = open('../../SJP_JC_Audio/gridsearch/phonetic_IS09-smallset_lstm_comprehensibility.csv', 'w')
    else:
        wfile = open('../../SJP_JC_Audio/gridsearch/phonetic_IS09-smallset_lstm_accentedness.csv', 'w')
    ...
    #     with open('../../SJP_JC_Audio/gridsearch/phonetic_IS09-smallset_lstm_comprehensibility.csv', 'w') as wfile:
    #         for item in total_stats:
    #             wfile.write(",".join(item))
    #             wfile.write("\n")
    # elif fpath == "../../SJP_JC_Audio/perception_results/fluency_avgs.csv":
    #     with open('../../SJP_JC_Audio/gridsearch/phonetic_IS09-smallset_lstm_fluency.csv', 'w') as wfile:
    #         for item in total_stats:
    #             wfile.write(",".join(item))
    #             wfile.write("\n")
    # else:
    #     with open('../../SJP_JC_Audio/gridsearch/phonetic_IS09-smallset_lstm_accentedness.csv', 'w') as wfile:
    #         for item in total_stats:
    #             wfile.write(",".join(item))
    #             wfile.write("\n")
