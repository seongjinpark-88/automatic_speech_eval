...
phonetic_test = modeler.GetFeatures("../../SJP_JC_Audio/wavs", "~/opensmile-2.3.0", "../../SJP_JC_Audio/IS10_featureset")
...
for fpath in types:
    ...
    adapt = modeler.AdaptiveModel(unzipped_feats, unzipped_ys, shape, "../../SJP_JC_Audio/IS10_featureset")
    ...
    if fpath == "../../SJP_JC_Audio/perception_results/fluency_avgs.csv":
        wfile = open('../../SJP_JC_Audio/gridsearch/phonetic_IS10-full_lstm_fluency.csv', 'w')
    elif fpath == "../../SJP_JC_Audio/perception_results/comp_avgs.csv":
        wfile = open('../../SJP_JC_Audio/gridsearch/phonetic_IS10-full_lstm_comprehensibility.csv', 'w')
    else:
        wfile = open('../../SJP_JC_Audio/gridsearch/phonetic_IS10-full_lstm_accentedness.csv', 'w')
