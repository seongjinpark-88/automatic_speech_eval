...
# phonetic_test = modeler.GetFeatures("../../SJP_JC_Audio/wavs", "~/opensmile-2.3.0", "../../SJP_JC_Audio/secondtest")
...
# adapt = modeler.AdaptiveModel(unzipped_feats, unzipped_ys, shape, "../../SJP_JC_Audio/secondtest")
#
...
#                 plt.savefig("train-loss_{0}-{1}-{2}-{3}.png".format(n_l_u, n_c_u, n_l, b))
#                 plt.clf()
...
# create an instance of GetFeatures class
summary_test = modeler.GetFeatures("../../SJP_JC_Audio/wavs", "~/opensmile-2.3.0", "../../SJP_JC_Audio/secondtest")
# uncomment to extract features for first time use
...
# read in y data
summary_y_values = summary_test.get_ys_dict("../../SJP_JC_Audio/perception_results/accented_avgs.csv",
                                    speaker_list)

# zip x and y data
summary_zipped = summary_test.zip_feats_and_ys(summary_features, summary_y_values)
...
# create instance of class AdaptiveModel
sum_adapt = modeler.AdaptiveModel(unzipped_summary_feats, unzipped_summary_ys, summary_shape, "../../SJP_JC_Audio/secondtest")
...
for n_c_u in n_connected_units:
    for n_c in n_connected:
        for b in batch:
            ...
            valy, y_preds = sum_adapt.train_and_predict(sum_model, train_summ_X, train_summ_y, val_summ_X, val_summ_y, batch=b)
            ...
            plt.savefig("mlp_dev-loss_{0}-{1}-{2}.png".format(n_c_u, n_c, b))
            plt.clf()