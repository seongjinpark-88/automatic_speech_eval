...
from utils import music_tagger_cnn as my_models
...
def main(mode, conv_until=None):
    ...
    # This is it. use melgram, up to 6000  is assumed to be 12000, see model.py),
    # do decibel scaling
    ...
    # assert K.common.image_dim_ordering() == 'th', ('image_dim_ordering should be "th". ' +
